...
import { Button, HeaderBar, Title, notify, prompt } from "@habx/ui-core";
...
export const useImportTable = <D extends { id?: string | number }>(
  ...
  const inputProps = React.useMemo(() => dropzone.getInputProps(), [dropzone]);
